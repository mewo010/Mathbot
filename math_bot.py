...
# הטוקן והצ'אט איידי שלך
TELEGRAM_BOT_TOKEN = "8800158740:AAF7ed-x5UBdtqpATuBUrBpdChzTQHOFIQ4"
TELEGRAM_CHAT_ID = "6328503953"

# תוכנית לימודים מורחבת (20 ימים מלאים למגמה מדעית לכיתה ט')
...
# מאגר משפטי מוטיבציה עשיר (נבחר אקראית בצורה מאובטחת לענן)
motivation_quotes = [
    {
    ...
    {
        "quote": "הדבר היחיד שעומד בינך לבין המטרה שלך הוא הסיפור שאתה ממשיך לספר לעצמך.",
    ...
    {
        "quote": "ההבדל בין האפשרי לבלתי אפשרי טמון בנחישות של האדם.",
        "author": "טומי לוסר",
    },
    {
        "quote": "מי שמעז להיכשל בגדול, יכול להגיע להישגים גדולים.",
        "author": "רוברט קנדי",
    },
    {
    ...
    {
        "quote": "ההצלחה היא תוצאה של סדרת פעולות קטנות שאנו עושים בעקביות.",
        "author": "וינס לומبارדי",
    },
    {
        "quote": "אל תמדוד את ההצלחה שלך לפי איפה שאתה עכשיו, אלא לפי המרחק שעברת.",
        "author": "ג'ון מקסويل",
    },
    {
        "quote": "הזמן הטוב ביותר לשתול עץ היה לפני 20 שנה. הזמן השני הכי טוב הוא עכשיו.",
        "author": "פתגם סיני",
    },
    {
        "quote": "המאמץ שאתה משקיע היום הוא הביטחון העצמי שלך מחר.",
        "author": "אלבר קאמי",
    },
    {
        "quote": "סקרנות היא המנוע שמניע את המדע קדימה.",
        "author": "מארי קיורי",
    },
]
